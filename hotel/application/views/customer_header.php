          ...
          <div class="nav-collapse">
            <ul class="nav pull-right">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                  class="icon-user"></i> <?=FULLNAME?> (<?=EMAIL?>) <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li><a href="<?php echo base_url('login/logout'); ?>">Logout</a></li>
                  </ul>
                </li>
                <li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Customer</a>
                </li>
              </ul>
        ...
        <div class="subnavbar-inner">
          <div class="container">
            ...
            <!-- <li <? if($page == "employee"){ echo 'class="active"'; } ?>><a href="<?php echo base_url('employee'); ?>"><i class="icon-user"></i><span>Employees</span> </a> </li> -->
              <li <? if($page == "reservation"){ echo 'class="active"'; } ?>><a href="<?php echo base_url('reservation'); ?>"><i class="icon-list-alt"></i><span>Reservations</span> </a> </li>
             ...
             <!-- /unneeded <li <? if($page == "departments"){ echo 'class="active"'; } ?>><a href="<?php echo base_url('departments'); ?>"><i class="icon-file"></i><span>Departments</span> </a> </li> -->
              <li <? if($page == "restaurant"){ echo 'class="active"'; } ?>><a href="<?php echo base_url('restaurant'); ?>"><i class="icon-fire"></i><span>Restaurants</span> </a> </li>
				<li class="dropdown <? if($page == 'account' || $page == 'room_type'){ echo 'active'; } ?>"><a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"> <i class="icon-cog"></i><span>Account</span> <b class="caret"></b></a>
					<ul class="dropdown-menu">
					<li><a href="<?php echo base_url('settings'); ?>">Account Settings</a></li>
					</ul>
			  <li <? if($page == "help"){ echo 'class="active"'; } ?>><a href="<?php echo base_url(); ?>"><i class="icon-question"></i><span>Help</span> </a> </li>
