...
--
-- Table structure for table `reservation type`
--

CREATE TABLE IF NOT EXISTS `reservation_type` (
  `rType_id` int(11) NOT NULL AUTO_INCREMENT,
  `rType_name` varchar(50) NOT NULL,
  `rType_payment_time` int(11) NOT NULL,
  `refund_if_canceled` int(11) NOT NULL DEFAULT 0,
  `original_base_rate` float NOT NULL,
  `additional_base_rate` float NOT NULL,
  `min_days_before_reservation` int(11) NOT NULL,
  `notice_of_payment` int(11) NOT NULL,
...
INSERT INTO `reservation_type` (`rType_id`, `rType_name`, `rType_payment_time`, `refund_if_canceled`, `original_base_rate`, `additional_base_rate`, `min_days_before_reservation`, `notice_of_payment`) VALUES
(1, 'Prepaid Reservation', 0, 0, 0.75, 1.1, 90, 0),
(2, '60 Days in Advance Reservation', 30, 0, 0.85, 1.1, 60, 45);
